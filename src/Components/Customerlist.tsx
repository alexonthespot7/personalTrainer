...
const apiUrl: string | undefined = 'https://traineeapp.azurewebsites.net';
...
function CustomerList() {
    ...
    const linkGetter = (params: any): any => {
        return params.data.links[0].href;
    }

    const addCustomer = async (newCustomer: Customer): Promise<void> => {
        try {
    ...
    const updateCustomer = async (updatedCustomer: any, link: any) => {
        try {
    ...
    const addTraining = async (newTraining: Training): Promise<void> => {
        try {
    ...
    const columns = [
        ...
        },
        {
            ...
            width: 100,
            field: 'links.0.href',
            cellRenderer: (params: any) => <Editcustomer params={params} updateCustomer={updateCustomer} />
        },
        {
            headerName: '',
